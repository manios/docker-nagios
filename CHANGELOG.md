...
* NRPE: 4.1.3
* Alpine:
    * 3.21.3: `linux/amd64`, `linux/i386`, `linux/arm64`
    * 3.12.12: `linux/arm/v6`, `linux/arm/v7`

### Features

* Use Alpine 3.21 as base image for `linux/amd64`, `linux/i386`, `linux/arm64`. Until [nagioscore #1025](https://github.com/NagiosEnterprises/nagioscore/issues/1025) is fixed, we are going to use 3.12 as base image for `linux/arm/v6` and `linux/arm/v7`. ([#92](https://github.com/manios/docker-nagios/issues/92))
...
* NRPE: 4.1.3
* Alpine:
    * 3.12.12: `linux/amd64`, `linux/i386`, `linux/arm64`, `linux/arm/v6`, `linux/arm/v7`
